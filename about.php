	...
	<body>
		...
		<div class="container">
			...
			<div class="row gallery">
				<img class="col-sm-4 gallery_img" src="img/glacier-1714261_640.jpg" width="320" height="240"/>
				<img class="col-sm-4 gallery_img" src="img/fall-1432252_640.jpg" width="320" height="240"/>
				<img class="col-sm-4 gallery_img" src="img/tree-1715298_640.jpg" width="320" height="240"/>
			</div>
			<h2>Who We Are</h2>
